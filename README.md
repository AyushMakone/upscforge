...
- save my study progress,
- track my completion level,
- generate topic-based MCQs,
- help with Mains answer practice,
...
- track daily or weekly study progress,
- monitor preparation across GS papers and optional subjects,
...
- multi-statement Prelims MCQs,
- topic-based practice questions,
- descriptive Mains answers,
- and PSIR-specific content based on the selected subject area.
...
git clone https://github.com/ayushmakone/upscforge.git
...
- This project is built for aspirants targeting UPSC CSE .
- The app is focused on practical preparation and smart revision.
- If AI features are enabled through Gemini, make sure your API credentials are configured properly in the project environment.
---

## Summary
UPSCForge is a study companion for serious UPSC aspirants. It combines tracking, AI-generated practice, and exam-focused planning in one simple tool to make preparation more organized and effective.

If you are preparing for UPSC CSE, this kind of system can help you stay consistent and focused.